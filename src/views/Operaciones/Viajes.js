...
import { Button, ListPage, Select, Label, FormGroup, Card, CardBody, CardTitle, Input, RSelectAsync, Permission } from 'temeforest'
                                ...
                                <CardBody>
                                    <div className="col-sm-12">
                                        <ListPage
                                            ...
                                            searchable={false}
                                            fieldNames={['Frecuencia','Hora salida', 'Cooperativa', 'Disco', 'Ruta']}
                                            fields={['frecuencia_nombre', 'hora_salida', 'cooperativa_nombre',
