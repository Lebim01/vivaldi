            ...
            <div>
                <form className="mt-4 form-horizontal">
                    ...
                    <FormGroup className="row">
                        ...
                        <div className="col-sm-5">
                            <Input value={this.props.cantidad_aprobada} readOnly />
                        </div>
                    </FormGroup>
                    <FormGroup className="row">
                        <Label className="col-sm-3">Valor tasa</Label>
                        <div className="col-sm-5">
...
class EditSolicitudTasaContingencia extends React.Component {
    ...
    aprobar(){
        ...
        Swal.fire({
            ...
            preConfirm: () => {
                return axios.post(`${baseurl}/venta/solicitud_tasacontingencia/${id ? `${id}/` : ``}`, { id, estado: 1 })
                .then(response => {
            ...
            <div className="animated fadeIn">
                <Row>
                    <Col xs="12" md="12">
                        <Card>
                            <CardBody>
                                <CardTitle>Crear/Editar Solicitud de tasa contingencia</CardTitle>
                                <CardBody>
...
export default EditSolicitudTasaContingencia